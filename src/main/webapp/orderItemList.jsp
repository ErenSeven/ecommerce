...
try {
    ...
    // Get order_id parameter from URL
    String orderIdParam = request.getParameter("order_id");
    if (orderIdParam != null && !orderIdParam.isEmpty()) {
        int orderId = Integer.parseInt(orderIdParam);

        List<OrderItems> oilist = oIdao.getOrderItemsByOrderId(orderId);
        
        // Set orderItemsList attribute for use in JSP
        request.setAttribute("orderItemsList", oilist);
    } else {
        // Handle case where order_id parameter is missing or invalid
        System.out.println("order_id parameter is missing or invalid");
    ...
    if (olist == null || olist.isEmpty()) {
        ...
        System.out.println("Number of orders found: " + olist.size());
    }
%>
<!doctype html>
<html lang="zxx">
...
<body>
  ...
  <section class="contact-section section_padding">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <h2 class="contact-title">siparis Detayları</h2>
        </div>
        <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <% for (OrderItems oi : (List<OrderItems>) request.getAttribute("orderItemsList")) { %>
                                        <tr>
                                            <th scope="row"><%= oi.getOrderItemId() %></th>
                                            <td><%= oi.getOrder().getOrderId() %></td>
                                            <td><%= oi.getProduct().getpName() %></td>
