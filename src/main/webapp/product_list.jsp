                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    ...
                                    <h3> <a href="product_details.jsp">Cervical pillow for airplane
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    ...
                                    <h3> <a href="product_details.jsp">Geometric striped flower home classy decor</a> </h3>
                                    <p>From $5</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    ...
                                    <h3> <a href="product_details.jsp">Foam filling cotton slow rebound pillows</a> </h3>
                                    <p>From $5</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    ...
                                    <h3> <a href="product_details.jsp">Memory foam filling cotton Slow rebound pillows</a> </h3>
                                    <p>From $5</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    ...
                                    <h3> <a href="product_details.jsp">Sleeping orthopedic sciatica Back Hip Joint Pain relief</a> </h3>
                                    <p>From $5</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6">
